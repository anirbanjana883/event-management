          ...
          <div className="hidden md:flex items-center gap-6">
            {user ? (
              <>
                ...
                <Link
                  to="/dashboard" // This goes to the Gateway (Traffic Cop)
            ...
            {user ? (
              <>
                ...
                {user.role === 'organizer' && (
                    <Link
                    to="/create-event"
                    className="block px-2 py-2 text-red-400 hover:text-white hover:bg-[#1a1a1a] rounded transition-colors"
